                ...
                <div className="flex flex-col w-full">
                    <div className="flex items-center gap-x-2">
                        <div className="flex items-center">
                            <p onClick={memberClick} className="font-semibold text-sm hover:underline cursor-pointer">
                                {member.profile.name}
                            </p>
                    ...
                    {!fileUrl && isEditing && (
                        <Form {...form}>
                            <form
                                ...
                                />
                                <Button className='hover:bg-[#e4e4e7e6] transition dark:hover:bg-[#3f3f46bf]' disabled={isLoading} size="sm" variant="ghost">
                                    Save
                                </Button>
                            </form>
